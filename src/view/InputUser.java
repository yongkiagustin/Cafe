...
public class InputUser extends javax.swing.JFrame {
    ...
    public void kosong() {
        ...
        jTextNamaUser.setText(null);
        
    }

    //untuk menambah data barang
    public void TambahData() {
        if ((jTextNamaUser.getText().equals(null)) | (jTextUsername.getText().equals(null)) | (jPasswordField1.getText().equals(null))) {
            JOptionPane.showMessageDialog(this, "Data tidak boleh ada yang kosong");

        } else {
            try {
            String sql = "INSERT INTO tb_users (username, nama_user, password) VALUES ('" + jTextUsername.getText() + "','" + jTextNamaUser.getText() + "', " + "MD5('" + jPasswordField1.getText() + "'))";
            java.sql.Connection conn = (Connection) Config.currentConnection;
    ...
    public void EditData() {
        ...
        String nama = jTextNamaUser.getText();
        String pass = jPasswordField1.getText();
        int idUser = id_user;
        try {
            String sql = "update tb_users "
    ...
    public void hapus_data() {
        // fungsi hapus data
        try {
            String sql = "delete from tb_users where id_user='" + id_user + "'";
            java.sql.Connection conn = (Connection) Config.currentConnection;
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    private void initComponents() {
        ...
        jTextNamaUser = new javax.swing.JTextField();
        ...
        jTextUsername.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N

        jTextNamaUser.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextNamaUser, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
                .addGap(19, 19, 19)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        id_user = Integer.parseInt(jTable1.getValueAt(baris, 1).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputUser.class
    ...
    private javax.swing.JTextField jTextNamaUser;
